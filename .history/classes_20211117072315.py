...
class Neptune: 
    ...
    def launch_benchmark(self):
        ...
        self.box_plot_pehe.savefig("./box_plot_pehe_exp/"+self.experiment_name+"_"+str(self.num_runs)+".png")
        
        self.box_plot_surv0 = Ev.box_plot_surv0
        self.box_plot_surv0.savefig("./box_plot_surv0_exp/"+self.experiment_name+"_"+str(self.num_runs)+".png")
        
        self.box_plot_surv1 = Ev.box_plot_surv1
        self.box_plot_surv1.savefig("./box_plot_surv1_exp/"+self.experiment_name+"_"+str(self.num_runs)+".png")
        
        self.box_plot_FSM = Ev.box_plot_FSM
        self.box_plot_FSM.savefig("./box_plot_FSM_exp/"+self.experiment_name+"_"+str(self.num_runs)+".png")
