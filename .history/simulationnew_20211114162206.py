...
class SimulationNew:
    ...
    def __init__(self, params_simu):
        ...
        self.latex = params_simu['scheme'].get_latex_scheme()
...
class Scheme:
    ...
    # get latex representation of the function with sympy
    def get_latex_scheme(self):
        # convert function to sympy
        f = sympy.sympify(self.function)
        # get latex representation
        latex_f = sympy.latex(f)
        return latex_f
