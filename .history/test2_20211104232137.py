...
class EMA_strategy:
    ...
    def plot_ema_prediction(self):
        ...
        trace1 = go.Scatter(x=df['open_time'], y=df['ema'],
                            name='EMA', line=dict(color='#17BECF'))
        trace2 = go.Scatter(x=df['open_time'], y=df['close'],
                            name='Close Price', line=dict(color='#7F7F7F'))
        trace3 = go.Scatter(x=df['open_time'], y=df['buy_list'],
                            name='Buy List', line=dict(color='#FF0000'))
        trace4 = go.Scatter(x=df['open_time'], y=df['sell_list'],
                            name='Sell List', line=dict(color='#0000FF'))
        data = [trace1, trace2, trace3, trace4]
        layout = dict(title=self.coin,
                      xaxis=dict(
                          rangeselector=dict(
                              buttons=list([
                                  dict(count=1,
        ...
        py.plot(fig, filename='EMA prediction')
