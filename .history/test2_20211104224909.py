...
class EMA_strategy:
    def __init__(self, coin, interval, date1, date2):
        self.coin = coin
        ...
        self.strategy = 'EMA'
    def get_data(self):
        self.df = Binance().get_data_by_coin_df(self.coin, self.interval, self.date1, self.date2)
...
# test EMA strategy
E = EMA_strategy('SHIBUSDT', Client.KLINE_INTERVAL_1MINUTE, '1 day ago UTC', 'now UTC')
E.get_data()
E.get_ema_list(5)
E.get_buy_list()
E.get_sell_list()
