...
class Neptune: 
    ...
    def get_evaluation(self):
        ...
        return self.Ev
    def launch_benchmark(self,n_trials):
        Ev = self.get_evaluation()
        Ev.All_Results(list_models=self.list_models,
                        is_train=False,params_bart=self.p_bart_best)
        
        
        self.benchmark.plot_benchmark()
        self.send_plot(self.benchmark.fig, "benchmark",self.num_runs)
        self.benchmark.save_benchmark()
        self.send_data(self.benchmark.data, "benchmark",self.num_runs)
