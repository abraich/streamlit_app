...
class Binance : 
    ...
    def get_data_by_coin(self, coin, interval):
        ...
        df = pd.DataFrame(list_d, columns=['Open time', 'Open', 'High', 'Low', 'Close', 'Volume', 'Close time', 'Quote asset volume', 'Number of trades', 'Taker buy base asset volume', 'Taker buy quote asset volume', 'Ignore'])
        return df
