...
class SimulationNew:
    ...
    def __init__(self, params_simu):
        ...
        Scheme_function = params_simu['scheme_function']
        Scheme_type = params_simu['scheme_type']
        ...
        self.scheme_function = Scheme_function
    ...
    def S(self, xbeta_p, tt_p, t):  # Agathe : pourquoi X apparait et pas Xbeta ?
        ...
        if self.scheme == 'linear':
            ...
            sh_z = self.scheme_function(xbeta_p) + c_tt
    ...
    def simulation_T(self, tt):
        ...
        if self.scheme == 'linear':  # schema linéraire ens X
            ...
            log_T = 1.0 / self.alpha * (np.log(-log_u) - self.scheme_function(self.Xbeta) - c_tt)
...
class Scheme:
    ...
    def __init__(self, type_s, function):
        self.type = type_s
        self.function = function  # fonction de x 
...
print(scheme.get_function()(1,2,3))