...
class Neptune:
    ...
    def send_plot(self, fig, name, num_run):
        ...
        self.experiment["plot_exp/"+name+"_"+str(num_run)].upload(
            File("./plot_exp/"+name+"_"+str(num_run)+".png"))
    ...
    def get_plots_patients(self, patient=0):
        for model_name in self.list_models[1:]:
            ...
            self.experiment["plot_exp/surv_"+model_name+"_exp" +
                            str(self.num_runs)+"wd_"+str(self.wd)].upload(File(path_fig_surv))
            
            self.experiment["plot_exp/cate_"+model_name+"_exp" +
