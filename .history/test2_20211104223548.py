...
# define a class for using bianance api to sell/buy list of coins with a grid strategy
...
class Grid_Trading :
    def __init__(self, binance, coins, interval, base_price, increment, base_quantity, increment_quantity, min_quantity, max_quantity, min_price, max_price):
        ...
        self.increment_quantity = increment_quantity
