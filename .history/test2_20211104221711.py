...
class Binance : 
    ...
    def get_data_by_coin_df(self, coin, interval,date1,date2):
        return self.client.get_historical_klines(symbol=coin, interval=interval, start_str=date1, end_str=date2)

    def get_data_by_coin_df_all(self, coin, interval):
        return self.client.get_historical_klines(symbol=coin, interval=interval, start_str='1 day ago UTC', end_str='now UTC')
