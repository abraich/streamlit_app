...
class Neptune: 
    ...
    def launch_benchmark(self):
        ...
        self.bilan_csv.to_csv("./bilan_exp/"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".csv")
        
        self.experiment["bilan_exp/"+self.experiment_name+"_"+str(self.num_runs)].upload(File("./bilan_exp/"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".csv"))
        # box plots
        self.box_plot_cate = Ev.box_plot_cate
        self.box_plot_cate.savefig("./box_plot_exp/cate_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
        self.experiment["box_plot_exp/cate_"+self.experiment_name+"_exp"+str(self.num_runs)].upload(File("./box_plot_exp/cate_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
             
        self.box_plot_pehe = Ev.box_plot_pehe
        self.box_plot_pehe.savefig("./box_plot_exp/pehe_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
        self.experiment["box_plot_exp/pehe_"+self.experiment_name+"_exp"+str(self.num_runs)].upload(File("./box_plot_exp/pehe_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
        
        
        self.box_plot_surv0 = Ev.box_plot_surv0
        self.box_plot_surv0.savefig("./box_plot_exp/surv0_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
        self.experiment["box_plot_exp/surv0_"+self.experiment_name+"_exp"+str(self.num_runs)].upload(File("./box_plot_exp/surv0_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
        
        self.box_plot_surv1 = Ev.box_plot_surv1
        self.box_plot_surv1.savefig("./box_plot_exp/surv1_" +self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
        self.experiment["box_plot_exp/surv1_"+self.experiment_name+"_exp"+str(self.num_runs)].upload(File("./box_plot_exp/surv1_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
        
        self.box_plot_FSM = Ev.box_plot_FSM
        self.box_plot_FSM.savefig("./box_plot_exp/FSM_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
        self.experiment["box_plot_exp/FSM_"+self.experiment_name+"_exp"+str(self.num_runs)].upload(File("./box_plot_exp/FSM_"+self.experiment_name+"_exp"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
        
    def get_plots_patients(self,patient=0):
        for model_name in self.list_models[1:] :
            fig_surv,fig_cate = plots(patient, self.Ev.d_list_models, model_name)
            # save plots
            fig_surv.savefig("./plot_exp/surv_"+model_name+"_"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
            self.experiment["plot_exp/surv_"+model_name+"_exp"+str(self.num_runs)].upload(File("./plot_exp/surv_"+model_name+"_"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
            fig_cate.savefig("./plot_exp/cate_"+model_name+"_"+str(self.num_runs)+"wd_"+str(self.wd)+".png")
            self.experiment["plot_exp/cate_"+model_name+"_exp"+str(self.num_runs)].upload(File("./plot_exp/cate_"+model_name+"_"+str(self.num_runs)+"wd_"+str(self.wd)+".png"))
            
    def get_wd_dist(self):
        self.wd = self.simu.wd
    ...
    def concatenate_list_bilan(self):
        ...
        df_concat.to_csv("./bilan_exp/all_bilan_"+self.experiment_name+"_"+str(self.num_runs)+".csv")
        self.experiment["bilan_exp/all_bilan_"+self.experiment_name+"_"+str(self.num_runs)].upload(File("./bilan_exp/all_bilan_"+self.experiment_name+"_"+str(self.num_runs)+".csv"))
