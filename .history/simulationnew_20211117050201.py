...
class Neptune: 
    ...
    def send_data(self, df, name,num_run):
        ...
        self.experiment["data_exp/"+name+"_"+str(num_run)] = df
        
        
    def send_param(self, param, name,num_run):
        param.to_csv("./param_exp/"+name+"_"+str(num_run)+".csv")
        self.experiment["param_exp/"+name+"_"+str(num_run)].upload(File.as_image(numpy_array))
        
    def send_plot(self, fig, name,num_run):
        fig.savefig("./plot_exp/"+name+"_"+str(num_run)+".png")
        self.experiment["plot_exp/"+name+"_"+str(num_run)].upload(File.as_image(fig))
