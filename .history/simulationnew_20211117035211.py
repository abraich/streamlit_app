...
# test Neptune
neptune_exp = Neptune("test_neptune")
neptune_exp.create_experiment()
neptune_exp.send_param(p_sim)
neptune_exp.send_param(p_exp)
neptune_exp.send_data(data, "data_sim.csv")
neptune_exp.send_data(data_exp, "data_exp.csv")
neptune_exp.send_plot(neptune_exp.plot_dist(), "distribution.png")
neptune_exp.send_plot(neptune_exp.plot_surv_true(), "surv_true.png")
